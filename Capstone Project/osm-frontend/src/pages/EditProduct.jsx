...
function EditProduct() {
  ...
  const handleUpdate = async () => {
    ...
    try {
      await API.put(`/products/${id}`, { ...product, price: Number(product.price), stockQuantity: Number(product.stockQuantity) });
      ...
      <div className="card max-w-lg">
        <div className="space-y-4">
          ...
          <div className="flex gap-3 pt-2">
            <button onClick={handleUpdate} className="btn flex-1">Update Product</button>
